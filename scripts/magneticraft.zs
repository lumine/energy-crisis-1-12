...
# copper <magneticraft:rocky_chunks:2> <gravelores:copper_gravel_ore>
# lead  <magneticraft:rocky_chunks:3> <gravelores:lead_gravel_ore>
# tin <magneticraft:rocky_chunks:13> <magneticraft:chunks:13> <gravelores:tin_gravel_ore>
...
mods.magneticraft.SluiceBox.addRecipe(<gravelores:copper_gravel_ore>, 1.0, <magneticraft:chunks:2>, 0.25, <magneticraft:chunks:1>, 0.25, <libvulpes:productdust:7>, true);
...
mods.magneticraft.SluiceBox.addRecipe(<gravelores:lead_gravel_ore>, 1.0, <magneticraft:chunks:3>, 0.25, <magneticraft:chunks:5>, 0.25, <libvulpes:productdust:7>, true);
...
mods.magneticraft.SluiceBox.addRecipe(<gravelores:tin_gravel_ore>, 1.0, <magneticraft:chunks:13>, 0.25, <magneticraft:chunks:5>, 0.25, <magneticraft:chunks:7>, true);
